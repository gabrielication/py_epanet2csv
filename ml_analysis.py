...
target_y = data.has_leak
attributes_X = data.drop(["hour","nodeID","has_leak", "x_pos", "y_pos","leak_area_value", "leak_discharge_value", "current_leak_demand_value","node_type"],axis=1)
