...
if __name__ == "__main__":
    ...
    """
    path = "tensorflow_datasets/1W_one_res_small_no_leaks_rand_base_dem_nodes_output.csv"
    plot_user_demand(path, save=True, show=False)
    plot_hist_user_demand(path, save=True, show=False)
    plot_cumulative_hist_user_demand(path, save=True, show=False)